...
const i18n = {
	ru: {
		...
		projects_sub:
			'Горизонтальная карусель. Нажми «Подробнее» — откроется модалка с описанием.',
		...
		modal_open_app: 'Открыть приложение',
		modal_close: 'Закрыть',
		aria_prev: 'Назад',
		aria_next: 'Вперёд',
	...
	it: {
		...
		projects_sub:
			'Carosello orizzontale. Clicca «Dettagli» — si aprirà una modale con la descrizione.',
		...
		modal_open_app: 'Apri l’applicazione',
		modal_close: 'Chiudi',
		aria_prev: 'Indietro',
		aria_next: 'Avanti',
